...
`gam` will automatically add a command to your `PATH` and if GNOME is installed add a shortcut to the application. These are automatically removed when uninstalling applications.
